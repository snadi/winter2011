...
struct BlockDefectAnalyzer {
    enum DEFECTTYPE { None, Implementation, Configuration, Referential, Make };
//sarah
static unsigned int dead_blocks ;
static unsigned int undead_blocks ;
static unsigned int symbolic_blocks ;
static unsigned int logic_blocks ;
static unsigned int code_blocks ;
static unsigned int kconfig_blocks ;
static unsigned int missing_blocks ;
//end sarah
...
public:
//sarah
    static unsigned int getDeadBlocks()     { return dead_blocks; }
    static unsigned int getUndeadBlocks()     { return undead_blocks; }
    static unsigned int getSymbolicBlocks()     { return symbolic_blocks; }
    static unsigned int getLogicBlocks()     { return logic_blocks; }
    static unsigned int getCodeBlocks()     { return code_blocks; }
    static unsigned int getKconfigBlocks()     { return kconfig_blocks; }
	static unsigned int getMissingBlocks() 		{return missing_blocks;}
//endsarah
};
